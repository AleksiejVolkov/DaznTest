    ...
    fun fetchEvents(): Flow<List<Event>> = flowOf(
        listOf(
            Event(
                ...
                date = Utils.parseDate("2024-11-01T04:29:46.592Z"),
            ...
            Event(
                ...
                subtitle = "Ligue 1",
                date = Utils.parseDate("2024-10-31T02:22:13.828Z"),
            ...
            Event(
                ...
                subtitle = "UEFA Champions League",
                date = Utils.parseDate("2024-10-31T03:22:13.828Z"),
            ...
            Event(
                ...
                subtitle = "NBA",
                date = Utils.parseDate("2024-10-31T04:22:13.828Z"),
            ...
            Event(
                ...
                date = Utils.parseDate("2024-10-31T05:22:13.828Z"),
